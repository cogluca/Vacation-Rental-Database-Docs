...
Prenotazione(id, dataInizio, dataFine, alloggio, costoTotale, prenotante*, confermata, rifiutata, cancellata)
...
Recensione(id, valutazioneHost*, valutazioneOspite*, valutazioneAlloggio*, testo, pulizia, comunicazione, posizione, qualità-prezzo, visibile)

Recensione(valutazioneHost) referenzia Host(emailUtente)

Recensione(valutazioneOspite) referenzia Ospite(emailUtente)

Recensione(valutazioneAlloggio) referenzia Alloggio(id)
